...
function buildSystemPrompt(brand: BrandInput | undefined): string {
  return [
    ...
    "Движение: страница не статична. Добавь purposeful motion — scroll-reveal для секций (fade+translate при появлении во вьюпорте, через Framer Motion/CSS `@starting-style`, не через дёрганый JS-хак), плавные hover/focus-переходы на интерактивных элементах, при необходимости — смена ритма between секциями (не все блоки одного визуального веса). Анимация обязана быть тонкой и целенаправленной — не декорацией; уважай `prefers-reduced-motion`.",
    "Категорически избегай: центрирования всего подряд, секций одинакового веса, скруглённых карточек с акцентной полоской сбоку, декоративных градиентов и теней вместо иерархии, placeholder/lorem-текста — пиши реальный текст по теме брифа, полностью статичной страницы без единого перехода/reveal.",
